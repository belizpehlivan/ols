                    ...
                    while($rows = mysqli_fetch_assoc($res)){
                        ...
                        ?>
                            <tr>
                                ...
                                <td><a href="<?php echo SITEURL;?>admin/delete-content.php?id=<?php echo $content_id; ?>&course_id=<?php echo $course_id;?>&course_code=<?php echo $course_code;?>" class="btn btn-danger">Delete</a></td>
                            </tr>
                        <?php
                    }
                }
